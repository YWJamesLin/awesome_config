...
beautiful.init(awful.util.get_themes_dir() .. "customTheme/theme.lua")
...
mymainmenu = awful.menu({ items = { 
      	    ...
      	    { "　App.　", applicationmenu, beautiful.awesome_icon },
...
mybattery_timer = timer({timeout = 10})
...
globalkeys = awful.util.table.join(
    ...
    awful.key({                   }, "Print", function () awful.util.spawn(snapshot) end,
              {description = "create a screen shot", group = "launcher"}),
